...
class Player(Entity):
    def __init__(self, pos, groups, obstacle_sprites, create_attack, destroy_attack, create_magic):
        ...
        self.max_stats = {'health': 200,'energy': 180,'attack': 20,'magic': 20,'speed': 12}
        self.update_cost = {'health': 100,'energy': 100,'attack': 100,'magic': 100,'speed': 100}
        ...
        # import sound
        self.weapon_attack_sound = pygame.mixer.Sound('../ZELDA/audio/sword.wav')
        self.weapon_attack_sound.set_volume(0.1)
        self.death = pygame.mixer.Sound('../ZELDA/audio/death_player.wav')
        self.death.set_volume(1)
    def import_player_assets(self):
        character_path = '../ZELDA/graphics/player/'
    ...
    def input(self):
        if not self.attacking:
            ...
            if keys[pygame.K_LSHIFT] and self.dashing:
                self.dashing = False
